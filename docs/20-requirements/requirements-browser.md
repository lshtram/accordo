...
**Status:** ARCHIVED — superseded by `docs/20-requirements/requirements-browser-extension.md`  
...
> Archive note: kept for historical reference. Use `docs/20-requirements/requirements-browser-extension.md` for current requirements and status.
...
**Architecture reference:** [`docs/90-archive/architecture/browser-architecture.md`](../90-archive/architecture/browser-architecture.md)
