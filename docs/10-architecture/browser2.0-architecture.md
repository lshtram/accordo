...
**Depends on:** [`docs/10-architecture/architecture.md`](architecture.md) §14–15, [`docs/10-architecture/browser-extension-architecture.md`](browser-extension-architecture.md), [`docs/10-architecture/comments-architecture.md`](comments-architecture.md)  
