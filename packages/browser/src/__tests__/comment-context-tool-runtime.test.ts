...
describe("comment-context tool runtime", () => {
  ...
  it("retries nested same-origin iframe paths when stored frameId is stale", async () => {
    ...
    ;(relay.request as ReturnType<typeof vi.fn>)
      ...
      .mockResolvedValueOnce({ success: true, requestId: "req-page-map-current", data: { pageUrl: "https://example.com", pageId: "page-1", frameId: "main", snapshotId: "page-1:5", capturedAt: "2026-01-01T00:00:00Z", viewport: { width: 1280, height: 720, scrollX: 0, scrollY: 0, devicePixelRatio: 1 }, source: "dom", title: "Test", nodes: [], totalElements: 0, depth: 0, truncated: false, iframes: [{ frameId: "outer", sameOrigin: true, iframes: [{ frameId: "outer/inner", sameOrigin: true }] }] } })
  ...
  it("retries to main when a stale stored iframe id now resolves in the top document", async () => {
    ...
    ;(relay.request as ReturnType<typeof vi.fn>)
      .mockResolvedValueOnce({ success: true, requestId: "req-inspect-stale", data: { error: "action-failed" } })
      .mockResolvedValueOnce({ success: true, requestId: "req-excerpt-stale", data: { error: "action-failed" } })
      .mockResolvedValueOnce({ success: true, requestId: "req-page-map-current", data: { pageUrl: "https://example.com/page", pageId: "page-1", frameId: "main", snapshotId: "page-1:5", capturedAt: "2026-01-01T00:00:00Z", viewport: { width: 1280, height: 720, scrollX: 0, scrollY: 0, devicePixelRatio: 1 }, source: "dom", title: "Test", nodes: [], totalElements: 0, depth: 0, truncated: false, iframes: [] } })
      .mockResolvedValueOnce({ success: true, requestId: "req-page-map-retry", data: { pageUrl: "https://example.com/page", pageId: "page-1", frameId: "main", snapshotId: "page-1:5", capturedAt: "2026-01-01T00:00:00Z", viewport: { width: 1280, height: 720, scrollX: 0, scrollY: 0, devicePixelRatio: 1 }, source: "dom", title: "Test", nodes: [], totalElements: 0, depth: 0, truncated: false, iframes: [] } })
