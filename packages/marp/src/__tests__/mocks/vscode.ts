/**
 * VS Code mock for vitest unit tests in accordo-marp.
 *
 * Mapped to 'vscode' via vitest.config.ts resolve.alias.
 * Provides stubs for VS Code APIs called by accordo-marp modules.
 */
...
export const mockPanel = new MockWebviewPanel("accordo.marp.presentation", "Presentation");
