// ESLint flat config for accordo-editor (ESLint 10 + typescript-eslint 8).
...
export default [
  {
    ...
    languageOptions: {
      ...
      parserOptions: {
        ...
        // editor's tsconfig.json excludes src/__tests__ from the project,
        // so we must tell the parser to skip them too
